...
> gateway はこれを拒否する**」と述べています。実測でも、Claude Max サブスクリプション
> （gateway 経由）・Claude Code 2.1.263 の環境で、`/model` の一覧に Fable 5.1 が現れませんでした
> （2026-09-08）。バージョン要件は満たしていても、**接続経路が未対応なら選べません。**
> そのときは次のどちらかにしてください。
>
